...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://blog.chenyme.top/favicons/zolplay.png',
  '(?:github.com)': 'https://blog.chenyme.top/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://blog.chenyme.top/favicons/twitter.png',
  'coolshell.cn': 'https://blog.chenyme.top/favicons/coolshell.png',
  'vercel.com': 'https://blog.chenyme.top/favicons/vercel.png',
  'nextjs.org': 'https://blog.chenyme.top/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://blog.chenyme.top/favicon_blank.png'
